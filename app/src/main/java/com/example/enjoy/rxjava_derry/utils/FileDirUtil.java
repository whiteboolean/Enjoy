...
import com.example.enjoy.rxjava_derry.CustomApplication;
...
public class FileDirUtil {
    ...
    public String getFilesDir(){
        File dir = CustomApplication.getInstance().getFilesDir();
    ...
    public String getCacheDir(){
        File dir = CustomApplication.getInstance().getCacheDir();
        return dir.getAbsolutePath();
    }
    ...
    public String getExternalCacheDir(){
        File dir = CustomApplication.getInstance().getExternalCacheDir();
        return dir.getAbsolutePath();
    }
    ...
    public List<File> getExternalCacheDirs(){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            list.addAll(Arrays.asList(CustomApplication.getInstance().getExternalCacheDirs()));
        }
        return list;
    }
    ...
    public String getExternalFilesDir(){
        ...
        File dir = CustomApplication.getInstance().getExternalFilesDir("aa");
        return dir.getAbsolutePath();
    }
    ...
    public List<File> getExternalFilesDirs(){
        ...
        List<File> list = new ArrayList<>();
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            list.addAll(Arrays.asList(CustomApplication.getInstance().getExternalFilesDirs("aa")));
        }
        return list;
    }
    ...
    public String getObbDir(){
        File dir = CustomApplication.getInstance().getObbDir();
        return dir.getAbsolutePath();
    }
    ...
    public List<File> getObbDirs(){
        ...
        List<File> list = new ArrayList<>();
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
            list.addAll(Arrays.asList(CustomApplication.getInstance().getObbDirs()));
        }
    ...
    public String getNoBackupFilesDir(){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            dir = CustomApplication.getInstance().getNoBackupFilesDir();
        }
    ...
    public String getCodeCacheDir(){
        File dir = null;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            dir = CustomApplication.getInstance().getCodeCacheDir();
        }
        return dir == null ? "" : dir.getAbsolutePath();
    }
    ...
    public String getDataDir(){
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            dir = CustomApplication.getInstance().getDataDir();
        }
        return dir == null ? "" : dir.getAbsolutePath();
    }
    ...
    public String getPackageCodePath(){
        String dir = CustomApplication.getInstance().getPackageCodePath();
        return dir;
    }
    ...
    public String getPackageResourcePath(){
        String dir = CustomApplication.getInstance().getPackageResourcePath();
        return dir;
    }
